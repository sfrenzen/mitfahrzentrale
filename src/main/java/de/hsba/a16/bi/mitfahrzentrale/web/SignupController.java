...
public class SignupController {
	...
	// TODO: 13.08.2018 Form Validation f�r diese Seite muss f�r diese Seite erstellt werden 
    ...
    public String signupShow (Model model){
		// nur f�r Testzwecke todo l�schen, wenn Ihr das nicht mehr bracht .. vergis bitte auch nicht den Code bei HTML zu l�schen auch
